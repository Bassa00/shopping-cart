                    ...
                    <div className="container">
                        <div className="row justify-content-center">
                                ...
                                <div className="row">
                                    <div className="col-lg-8 col-md-8">
                                        <div className="single-deal">
                                            ...
                                            <img className="img-fluid w-100" src={require("../styles/img/category/c1.jpg")} alt="" />
                                    ...
                                    <div className="col-lg-4 col-md-4">
                                        <div className="single-deal">
                                            <div className="overlay"></div>
                                            <img className="img-fluid w-100" src={require("../styles/img/category/c2.jpg")} alt="" />
                                    ...
                                    <div className="col-lg-4 col-md-4">
                                        <div className="single-deal">
                                            <div className="overlay"></div>
                                            <img className="img-fluid w-100" src={require("../styles/img/category/c3.jpg")} alt="" />
                                    ...
                                    <div className="col-lg-8 col-md-8">
                                        <div className="single-deal">
                                            <div className="overlay"></div>
                                            <img className="img-fluid w-100" src={require("../styles/img/category/c4.jpg")} alt="" />
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-deal">
                                    <div className="overlay"></div>
                                    <img className="img-fluid w-100" src={require("../styles/img/category/c5.jpg")} alt="" />
